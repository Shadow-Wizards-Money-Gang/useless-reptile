...
public class ShockwaveSphereEntity extends ProjectileEntity {
    ...
    protected void onEntityHit(EntityHitResult entityHitResult) {
        ...
        if (exposure > 0) {
            ...
            double mult = POWER * lengthMod * exposure;
            vec3d = vec3d.normalize().multiply(mult, mult, mult);
            ...
            if (target instanceof LivingEntity livingEntity) {
                ...
                livingEntity.damage(DamageSource.LIGHTNING_BOLT, (float) (2.5 * MathHelper.clamp(lengthMod, 1, 2)));
            }
        }
        affected.add(target);
    }
