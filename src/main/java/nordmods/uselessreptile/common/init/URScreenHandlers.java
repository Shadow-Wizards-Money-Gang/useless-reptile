...
public class URScreenHandlers{
    ...
    public static void init() {
        ...
        LIGHTNING_CHASER_INVENTORY = Registry.register(Registry.SCREEN_HANDLER,"lightning_chaser_inventory", new ScreenHandlerType<>(LightningChaserScreenHandler::new));
    }
}
