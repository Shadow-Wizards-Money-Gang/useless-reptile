...
public class URStatusEffects {
    ...
    public static final StatusEffect ACID = Registry.register(Registry.STATUS_EFFECT,
            new Identifier(UselessReptile.MODID, "acid"),
            new AcidStatusEffect());
    public static final StatusEffect SHOCK = Registry.register(Registry.STATUS_EFFECT,
